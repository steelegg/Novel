...
<head>
    ...
    <link href="../static/css/userdoc/content.css" rel="stylesheet" type="text/css">
        ...
        <div class="content-center">
            ...
            <div class="bottom-block">
                <ul class="menu-center">
                    <li class="current"><a href="/u/collection?id=${id}">${mec}</a></li>
                    <li><a href="/u/history?id=${id}">我的历史</a></li>
                    <li><a href="/u/comment?id=${id}">我的评论</a></li>
                </ul>
                <div class="bottom-block-content">
                    <ul>
                        <c:forEach items="${book}" var="b" varStatus="vs">
                            <li>
                                <img src="${b.cover}" >
                                <p class="book-name">${b.book_name}</p>
                                <p class="history"><a href="/text?id=${b.end_id}">${b.end_chapter}</a></p>
                            </li>
                        </c:forEach>
                    </ul>
                </div>
